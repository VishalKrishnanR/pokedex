...
export default function PokeCard(props) {
    ...
    useEffect(() => {
        ...
        //2. Check if the selected pokemon is in the cache otherwise fectch from the api
        ...
        <div className='poke-card'>
            ...
            <div className='type-container'>
                {types.map((typeObj, typeIndex) => {
                    return (
                        <TypeCard key={typeIndex} type={typeObj?.type?.name} selectedPokemon={selectedPokemon}/>
                    )
                })}
            </div>
